...
def test_user_examples():
    ...
    try:
        # Initialize translator with MarianMT backend
        print("Initializing translator with MarianMT backend...")
        ...
        for i, original_text in enumerate(user_examples, 1):
            ...
            try:
                translated = translator.translation_client.translate_with_retry(original_text)
...
for stopping the attack."""
        ...
        for i, line in enumerate(lines, 1):
            if line:
                translated_line = translator.translation_client.translate_with_retry(line)
